# senior-chatbots - Claude Code Onboarding Bundle

> **Auto-generated** - Do not edit manually
> Last updated: 2025-12-12 14:30:24
> Project: /Users/nikolashulewsky/senior-chatbots
...
```json
{
  "name": "senior-chatbots",
  "version": "1.0.0",
  "description": "Medicaid and ALF regulatory chatbots with RAG",
  "scripts": {
    "frontend": "cd frontend && npm run dev",
    "medicaid": "cd backend/medicaid && npm start",
    "alf": "cd backend/alf && python main.py",
    "install:all": "npm install && cd frontend && npm install && cd ../backend/medicaid && npm install && cd ../alf && pip install -r requirements.txt",
    "dev": "concurrently \"npm run medicaid\" \"npm run alf\" \"npm run frontend\""
  },
  "devDependencies": {
    "concurrently": "^9.2.1"
  }
...
```
total 88
drwxr-xr-x  10 nikolashulewsky  staff    320 Dec 12 14:30 .
drwxr-x---+ 41 nikolashulewsky  staff   1312 Dec 12 14:30 ..
-rw-------   1 nikolashulewsky  staff    516 Dec 12 13:33 .env
-rw-------   1 nikolashulewsky  staff    218 Dec 12 11:07 .env.example
-rw-------   1 nikolashulewsky  staff    253 Dec 12 13:30 .gitignore
drwxr-xr-x   4 nikolashulewsky  staff    128 Dec 12 11:05 backend
-rw-r--r--   1 nikolashulewsky  staff  13170 Dec 12 14:30 CLAUDE_ONBOARDING_senior-chatbots.md
drwxr-xr-x   8 nikolashulewsky  staff    256 Dec 12 13:50 frontend
-rw-------   1 nikolashulewsky  staff    579 Dec 12 11:08 package.json
-rw-------   1 nikolashulewsky  staff  11718 Dec 12 14:26 PROJECT_CONTEXT.md
